        ...
        <div id='subject' className='flex flex-col items-center gap-4 py-16 text-[#262626]'>
            ...
            <div className='flex sm:justify-center gap-4 pt-5 w-full overflow-scroll '>
                {subjectData.map((item, index) => (
                    <Link to={`/doctors/${item.subject}`} onClick={() => scrollTo(0, 0)} className='flex flex-col items-center text-xs cursor-pointer flex-shrink-0 hover:translate-y-[-10px] transition-all duration-500' key={index}>
